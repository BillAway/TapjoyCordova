...
Tapjoy.prototype.baInit=function(userID,appId,secretKey){
    if(!isAndroid()){
        return cordova.exec(
            ...
            Tapjoy.serviceName,
            "requestTapjoyConnect",
            [appID, secretKey]);//@todo this should only need one, will have to change objc

        return cordova.exec(
            function(){},
            function(){console.log('tapjoy: could not set user id.')},
            Tapjoy.serviceName,
            "setUserID",
            [userID]);
    }
        ...
        cordova.exec(function(winParam) {console.log('winParam',winParam)},
        ...
        cordova.exec(
            function(){
                cordova.exec(
                    function(){},
                    function(){
                        console.log('tapjoy: could not show ad.');
                    },
                    Tapjoy.serviceName,
                    "showFullScreenAd",
                    []);
            ...
            function(){
                console.log('tapjoy: could not get ad.');
            },
            Tapjoy.serviceName,
            "getFullScreenAd",
            []);
